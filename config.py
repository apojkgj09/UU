...
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/apojkgj09/UU")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN",None)
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/UI_IUB")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/UI_IUB")
AUTO_LEAVING_ASSISTANT = bool(getenv("AUTO_LEAVING_ASSISTANT", "True"))
AUTO_LEAVE_ASSISTANT_TIME = int(getenv("ASSISTANT_LEAVE_TIME", "50"))
